...
import com.xzy.web.ajax.util.RandomCodeUtils;
 ...
 *
 */
@WebServlet(name = "GenerateCodesServlet", value = "/get_codes")
public class GenerateCodesServlet extends HttpServlet {
	...
	public static final String RANDOM_CODE_KEY = UUID.randomUUID().toString();
	private Random random = new Random();
	private int code_spacing;// 验证码间距

	public GenerateCodesServlet() {
		super();
	...
	public String bulidCodes(HttpServletRequest req, HttpServletResponse resp) {
		...
		session.setAttribute(RANDOM_CODE_KEY, codesStr);
		g.dispose();
		try {
